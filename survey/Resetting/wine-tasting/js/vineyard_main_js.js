function main0() {
// The function tomoove the horizon svg
  $(document).ready(function(){
    $("#svgCloneContainer").appendTo("#svgTargetContainer");
    });
...
########################
------------------------
The document.get element by id is failing, but the elements by class name does not fail, maybe it as something to do with things not being loaded in the dom.................
------------------------
########################
*/
...
$('#google_translate_element').on('change','select.goog-te-combo',function(e){ $('#translateLanguage').val($(this).val())});
/*---------------------- /Translation ----------------------*/
...
function openDiv(e, answerName) {
  ...
  for (i = 0; i < tabcontent.length; i++) {
    if (tabcontent[i].id != answerName) {
    tabcontent[i].style.display = "none";
    }else {
    // tabcontent[i].style.display = "contents";
    }
  }
  ...
  var a = document.getElementById(answerName).style.display = "contents";
  console.log(document.getElementById(answerName))
...
function massConverter(source_el_id, target_el_id){
if(document.getElementById(source_el_id).value == "kg"){
