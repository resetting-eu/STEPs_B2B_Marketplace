// "use strict";
function mainHoriz0() {
  const svg = d3.select("#chart_horiz0");
  const chart = svg
    .attr("id", "chart_horiz0")
    .append("g")
  ...
  defs
    .append("clipPath")
    .attr("id", "trianglePath_horiz0")
    .append("path")
    .attr("d", _textureTernaryPlot.triangle());

  defs
    .append("marker")
    .attr("id", "arrow_horiz0")
    .attr("markerWidth", "10")
  ...
  const siltCell = res_display_table_horiz0.rows[1].cells[0];
  const clayCell = res_display_table_horiz0.rows[1].cells[1];
  const sandCell = res_display_table_horiz0.rows[1].cells[2];
