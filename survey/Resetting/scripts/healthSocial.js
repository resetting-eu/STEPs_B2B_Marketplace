...
//Social Security
const socialSecurityCheckbox = document.getElementById("social_security");
    const socialSecurityDetails = document.getElementById("social_security_details");
    ...
    const secondaryEducationValue = document.getElementById("PercentageEducationSecondary");
